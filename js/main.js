//import { cities } from "./city-mock.js";
...
$(document).ready(function () {
  ...
  //------- Location --------------//
  $.ajax({
    url: "https://indian-cities-api-nocbegfhqg.now.sh/cities?state=Tamil Nadu", // Replace with actual API URL
    method: "GET",
    dataType: "json",
  ...
  function footerIntagram() {
    var feed = new Instafeed({
      ...
      template:
        '<a href="{{image}}" class="mfp-ig-popup" data-effect="mfp-zoom-in" title="{{title}}"><img src="{{image}}" alt="{{caption}}"></a>',
      after: function () {
